...
const MealPlan = () => {
  ...
  let dataevents = [];
  let storedEventsDataString = localStorage.getItem("MealsData");
  ...
  function handleUpdateEvent(args) {
    ...
    let eventsString = JSON.stringify(dataevents);
    localStorage.setItem("MealsData", eventsString);
  }
  const scheduleData = extend(
    [],
  ...
  const roomData = [
    ...
    { Name: "Luch", Id: 2, Capacity: 7, Color: "#7fa900", Type: "Cabin" },
    { Name: "Dinner", Id: 3, Capacity: 5, Color: "#5978ee", Type: "Cabin" },
    {
      Name: "Brunch",
      Id: 4,
      Capacity: 15,
    ...
    { Name: "Snack", Id: 6, Capacity: 10, Color: "#00bdae", Type: "Cabin" },
    {
      Name: "Fruit",
      Id: 7,
      Capacity: 20,
  ...
  const getHeaderTitle = (data) => {
    return data.elementType === "cell" ? "Add Meals Plan" : "Meals Details";
  };
