      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-7xs mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 font-bold text-7xl">The majority our customers do not understand our features</h2>
            <p className="text-3xl text-gray-400">Streamline and Simplify Family Management with Ease.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              <svg className="w-20 h-20 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
              ...
              <h4 className="h4 mb-2">To-Do List Features</h4>
              <p className=" text-gray-400 text-center text-2lg" >Keep track of your tasks and stay organized with our intuitive and powerful To-Do List feature.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Tak Note Features</h4>
              <p className="text-2lg text-gray-400 text-center">Capture your thoughts, ideas, and important information with our convenient Take Note feature</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Family Management</h4>
              <p className="text-2lg text-gray-400 text-center"> Keep track of important events, appointments, and schedules for every family member in one centralized location</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Event Scheduler Features</h4>
              <p className="text-2lg text-gray-400 text-center">Effortlessly plan and coordinate your events with our event scheduler.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Contacts Features</h4>
              <p className="text-2lg text-gray-400 text-center">Stay connected with your family members and loved ones using our Contacts feature.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Meal's Plan Features</h4>
              <p className="text-2lg text-gray-400 text-center">Take the guesswork out of deciding what to cook and ensure your family enjoys nutritious and delicious meals every day</p>
            </div>
